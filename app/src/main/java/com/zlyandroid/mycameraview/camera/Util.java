...
public class Util {
    ...
    //图片保存地址
    public static String photographPath = Environment.getExternalStorageDirectory().getPath() + "/ACamera/Photo/";
    //视频保存地址
    public static String videotapePath = Environment.getExternalStorageDirectory().getPath() + "/ACamera/video/";
